      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-24">
            <h2 className="text-[5vw] leading-none font-medium tracking-tighter text-[#1D1D1F]">
                INTELLIGENT<br/>DISTRIBUTION.
            </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
          <ServiceCard 
            title="Residential" 
            desc="Hyper-efficient home energy ecosystems adapting to your lifestyle." 
            type="residential" 
          />
          <ServiceCard 
            title="Industrial" 
            desc="Gigawatt-scale voltage regulation for heavy manufacturing." 
            type="industrial" 
          />
          <ServiceCard 
            title="Smart Grid" 
            desc="Self-healing AI networks with zero-latency load balancing." 
            type="grid" 
          />
        </div>
      </div>
