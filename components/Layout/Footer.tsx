    ...
    <footer className="bg-[#050505] text-white pt-24 pb-12 px-6 border-t border-white/5 relative z-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 gap-10">
            <div>
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <span className="font-semibold tracking-tight text-xl">LUMA CORE</span>
                </div>
                <p className="max-w-md text-gray-500 text-sm leading-relaxed">
                    The nervous system of the modern world. We engineer the flow of energy from generation to consumption with absolute precision.
                </p>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 gap-4">
            <p>&copy; 2024 Luma Core Global Inc. All rights reserved.</p>
